...
@Description("storing element to arrays")
@Extends(Expression.class)
@SuppressWarnings("javadoc")
public class ArrayElementStoreExpression extends MetaClass {

    @Description("target array")
    Property<Expression> data = property();

    @Description("array element position")
    Property<Expression> index = property();

    @Description("storing value")
