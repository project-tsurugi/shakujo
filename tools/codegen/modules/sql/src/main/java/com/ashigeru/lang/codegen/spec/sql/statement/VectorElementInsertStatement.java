...
@Description("inserting elements into vectors")
@Extends(Statement.class)
@SuppressWarnings("javadoc")
public class VectorElementInsertStatement extends MetaClass {

    @Description("target vector")
    Property<Expression> data = property();

    @Description("insertion position")
    Property<Expression> index = property();

    @Description("inserting values")
    Property<List<Expression>> values = property();
}
