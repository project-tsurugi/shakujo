...
public class FunctionKey extends MetaClass {

    @Description("mix-in of function key provider")
    @Foreign
    @Interface
    public static class Provider extends MetaClass {

        @Description("referring function key")
        @Transient
        Property<FunctionKey> functionKey = property();
    }
}
