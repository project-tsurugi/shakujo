...
@Description("removing elements from vectors")
@Extends(Statement.class)
@SuppressWarnings("javadoc")
public class VectorElementDeleteStatement extends MetaClass {

    @Description("target vector")
    Property<Expression> data = property();

    @Description("begining index")
    Property<Expression> begin = property();

    @Description("ending index")
    Property<Expression> end = property();
}
