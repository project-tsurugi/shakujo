...
@Description("declaring program level variables")
@Extends(GlobalDeclaration.class)
@Extends(VariableKey.Provider.class)
@SuppressWarnings("javadoc")
public class GlobalVariableDeclaration extends MetaClass {
    ...
    public enum Attribute {
        ...
        @Description("variable is not modifiable")
        CONST,

        @Description("variable is just a program parameter")
        PARAMETER,
    }
}
