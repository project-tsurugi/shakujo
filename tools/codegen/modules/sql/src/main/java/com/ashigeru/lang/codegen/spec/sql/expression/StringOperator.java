...
@Description("string operator expression")
@Extends(Expression.class)
@SuppressWarnings("javadoc")
public class StringOperator extends MetaClass {

    @Description("string operator kind")
    ...
    public enum Kind {
        ...
        @Description("like with ignoring cases")
        LIKE_IGNORECASE,
