...
protected:
     ...
     * @see exit()
     */
    virtual bool enter([[maybe_unused]] expression::StringOperator const* node) {
        return enterDefault(node);
    }
     ...
     * @see enter()
     */
    virtual void exit([[maybe_unused]] expression::StringOperator const* node) {
        exitDefault(node);
    }
...
public:
     ...
     * @see expression::StringOperator
     */
    void walk(expression::StringOperator const* node);
