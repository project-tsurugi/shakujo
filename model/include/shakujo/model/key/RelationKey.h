 ...
 */
#ifndef SHAKUJO_MODEL_KEY_RELATION_KEY_H_
#define SHAKUJO_MODEL_KEY_RELATION_KEY_H_
...
/**
 * @brief Represents relation key.
 */
class RelationKey final {
public:
    /**
     * @brief an interface of RelationKey entity.
    ...
    public:
        ...
        /**
         * @brief Returns referring relation key.
         * @return referring relation key.
         */
        virtual RelationKey* relation_key() = 0;

        /**
         * @brief Returns referring relation key.
         * @return referring relation key.
         */
        virtual RelationKey const* relation_key() const = 0;

        /**
         * @brief Sets referring relation key.
         * @param relation_key referring relation key
         * @return this
         */
        virtual Provider& relation_key(std::unique_ptr<RelationKey> relation_key) = 0;
    };
...
public:
     ...
     */
    RelationKey() : entity_(nullptr) {}

    /**
     * @brief Constructs a new object.
     * @param entity the key entity
     */
    explicit RelationKey(std::unique_ptr<Entity> entity) : entity_(std::move(entity)) {}

    /**
     * @brief Destroys this object.
     */
    ~RelationKey() noexcept = default;

    /**
     * @brief Copy-constructs a new object.
     * @param other the source object
     */
    RelationKey(RelationKey const& other) = delete;
     ...
     * @return this
     */
    RelationKey& operator=(RelationKey const& other) = delete;

    /**
     * @brief Move-constructs a new object.
     * @param other the source object
     */
    RelationKey(RelationKey&& other) noexcept = default;
     ...
     * @return this
     */
    RelationKey& operator=(RelationKey&& other) noexcept = default;
    ...
    inline T const* entity() const {
        return const_cast<RelationKey*>(this)->entity<T>();
    }
};
}  // namespace shakujo::model::key

#endif  // SHAKUJO_MODEL_KEY_RELATION_KEY_H_
