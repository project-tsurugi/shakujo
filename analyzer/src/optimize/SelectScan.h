 ...
 */
#ifndef SHAKUJO_ANALYZER_OPTIMIZE_SELECT_SCAN_H_
#define SHAKUJO_ANALYZER_OPTIMIZE_SELECT_SCAN_H_
...
class SelectScan {
public:
    explicit SelectScan(Context& context) : context_(context) {}
...
#endif  //SHAKUJO_ANALYZER_OPTIMIZE_SELECT_SCAN_H_
