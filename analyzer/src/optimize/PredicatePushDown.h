 ...
 */
#ifndef SHAKUJO_ANALYZER_OPTIMIZE_PREDICATE_PUSH_DOWN_H_
#define SHAKUJO_ANALYZER_OPTIMIZE_PREDICATE_PUSH_DOWN_H_
...
public:
    explicit PredicatePushDown(Context& context) : context_(context) {}
...
#endif  //SHAKUJO_ANALYZER_OPTIMIZE_PREDICATE_PUSH_DOWN_H_
