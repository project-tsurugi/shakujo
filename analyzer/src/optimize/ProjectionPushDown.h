 ...
 */
#ifndef SHAKUJO_ANALYZER_OPTIMIZE_PROJECTION_PUSH_DOWN_H_
#define SHAKUJO_ANALYZER_OPTIMIZE_PROJECTION_PUSH_DOWN_H_
...
public:
    explicit ProjectionPushDown(Context& context) : context_(context) {}
...
#endif  //SHAKUJO_ANALYZER_OPTIMIZE_PROJECTION_PUSH_DOWN_H_
