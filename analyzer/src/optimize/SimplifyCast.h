 ...
 */
#ifndef SHAKUJO_ANALYZER_OPTIMIZE_SIMPLIFY_CAST_H_
#define SHAKUJO_ANALYZER_OPTIMIZE_SIMPLIFY_CAST_H_
...
class SimplifyCast {
public:
    explicit SimplifyCast(Context& context) : context_(context) {}
...
#endif  //SHAKUJO_ANALYZER_OPTIMIZE_SIMPLIFY_CAST_H_
