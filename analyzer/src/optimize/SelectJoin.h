 ...
 */
#ifndef SHAKUJO_ANALYZER_OPTIMIZE_SELECT_JOIN_H_
#define SHAKUJO_ANALYZER_OPTIMIZE_SELECT_JOIN_H_
...
class SelectJoin {
public:
    explicit SelectJoin(Context& context) : context_(context) {}
...
#endif  //SHAKUJO_ANALYZER_OPTIMIZE_SELECT_JOIN_H_
